...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("ALL_PRODUCTS"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class ALL_PRODUCTS
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As ALL_PRODUCTS = CType(MyBase.Clone,ALL_PRODUCTS)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "ALL_PRODUCTS"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/ALL_PRODUCTS.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As ALL_PRODUCTS = New ALL_PRODUCTS()
    ...
    Partial Public Class ProductsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddProductsRow(ByVal Code As String, ByVal Category As String, ByVal Name As String, ByVal Quantity As String, ByVal Price As String) As ProductsRow
            Dim rowProductsRow As ProductsRow = CType(Me.NewRow,ProductsRow)
            Dim columnValuesArray() As Object = New Object() {Code, Category, Name, Quantity, Price}
...
Namespace ALL_PRODUCTSTableAdapters
    ...
    Partial Public Class ProductsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([Code] = @Original_Code) AND ([Category] = @"& _ 
                "Original_Category) AND ([Name] = @Original_Name) AND ([Quantity] = @Original_Qua"& _ 
                "ntity) AND ([Price] = @Original_Price))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([Code], [Category], [Name], [Quantity], [Price]) VA"& _ 
                "LUES (@Code, @Category, @Name, @Quantity, @Price);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Code, Category, Name,"& _ 
                " Quantity, Price FROM Products WHERE (Code = @Code)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Products] SET [Code] = @Code, [Category] = @Category, [Name] = @Nam"& _ 
                "e, [Quantity] = @Quantity, [Price] = @Price WHERE (([Code] = @Original_Code) AND"& _ 
                " ([Category] = @Original_Category) AND ([Name] = @Original_Name) AND ([Quantity]"& _ 
                " = @Original_Quantity) AND ([Price] = @Original_Price));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Code, Category,"& _ 
                " Name, Quantity, Price FROM Products WHERE (Code = @Code)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Page2.My.MySettings.Default.FIFAConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Code, Category, Name, Quantity, Price FROM dbo.Products"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As ALL_PRODUCTS.ProductsDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As ALL_PRODUCTS.ProductsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As ALL_PRODUCTS.ProductsDataTable = New ALL_PRODUCTS.ProductsDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As ALL_PRODUCTS.ProductsDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As ALL_PRODUCTS) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Code As String, ByVal Original_Category As String, ByVal Original_Name As String, ByVal Original_Quantity As String, ByVal Original_Price As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Code As String, ByVal Category As String, ByVal Name As String, ByVal Quantity As String, ByVal Price As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Code As String, ByVal Category As String, ByVal Name As String, ByVal Quantity As String, ByVal Price As String, ByVal Original_Code As String, ByVal Original_Category As String, ByVal Original_Name As String, ByVal Original_Quantity As String, ByVal Original_Price As String) As Integer
            If (Code Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Code")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Category As String, ByVal Name As String, ByVal Quantity As String, ByVal Price As String, ByVal Original_Code As String, ByVal Original_Category As String, ByVal Original_Name As String, ByVal Original_Quantity As String, ByVal Original_Price As String) As Integer
            Return Me.Update(Original_Code, Category, Name, Quantity, Price, Original_Code, Original_Category, Original_Name, Original_Quantity, Original_Price)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As ALL_PRODUCTS, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As ALL_PRODUCTS, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._productsTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As ALL_PRODUCTS, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._productsTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As ALL_PRODUCTS) As Integer
